...
router.post('/check-out', (req, res) => {
  ...
  if (!checkoutArticle.material_number || !checkoutArticle.storage_room) {
    ...
    sql1 += ' SELECT "checked_out", 55555, 1, ?,';
    ...
    pool.getConnection((err, connection) => {
      ...
      connection.query(sql1, [checkoutArticle.comment, checkoutArticle.material_number, checkoutArticle.material_number, checkoutArticle.material_number, checkoutArticle.material_number, checkoutArticle.storage_room, checkoutArticle.storage_room, checkoutArticle.material_number], (err1, result1) => {
        connection.release();
        if (err1) {
          console.log(err1);
